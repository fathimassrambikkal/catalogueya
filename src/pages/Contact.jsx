              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-gray-600 hover:text-gray-900 transition text-sm break-all"
                  >
                    ux@catalogueya.com
                  </a>
                </div>
              ...
              <div className="flex gap-4 mt-8">
                {[
                  ...
                  },
                  {
                    ...
                    url: "https://www.tiktok.com/@catalogueya.qa?lang=en-GB",
                  },
                  {
                  ...
                  <a
                    ...
                    className="bg-white border border-gray-200 text-gray-700 p-3 rounded-full hover:bg-gray-50 hover:shadow transition"
                  >
                    {s.icon}
                  </a>
                ))}
