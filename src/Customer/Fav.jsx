...
function Fav() {
  ...
  const renderListCard = (list) => (
    ...
    >
      <div className="flex-1">
        ...
        {/* Only show item count for custom lists, not for "My Favourites" */}
      ...
      <div className="flex items-center space-x-3">
        ...
        {/* Edit Button - Disabled for default "My Favourites" list */}
        <button 
        ...
        {/* Delete Button - Disabled for default "My Favourites" list */}
        <button 
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50/30 p-4 sm:p-6">
      <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">My Lists</h1>
      
      <div className="space-y-4 max-w-2xl mx-auto">
        {/* Default "My Favourites" list and other lists */}
        ...
        {isCreating ? (
          ...
          >
            <div className="flex items-center justify-center">
              ...
              <span className="text-blue-500 font-semibold text-lg">Create a New List</span>
            </div>
          </button>
        )}
      </div>

      {/* Empty state when only default list exists */}
      {lists.length === 1 && lists[0].name === 'My Favourites' && !isCreating && (
        <div className="max-w-2xl mx-auto mt-8">
          <div className="text-center p-8 rounded-2xl
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Create Your First Custom List</h3>
            <p className="text-gray-600 text-sm mb-4">Organize your favorites into custom lists for better management</p>
            <button
              onClick={() => setIsCreating(true)}
