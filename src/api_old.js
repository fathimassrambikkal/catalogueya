...
export const getGoogleMap = () => api.post("/googlemap");
  ...
  return api.post(`/company/edit_company_post`, formData, {
    ...
    try {
      ...
      try {
        ...
        try {
          const response = await fetch(`https://catalogueyanew.com.awu.zxu.temporary.site/en/api/company/edit_company_post`, {
            method: 'POST',
