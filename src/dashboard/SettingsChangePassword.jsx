...
return (
  <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white flex flex-col items-center px-4 sm:px-6 lg:px-8">
        ...
        >
          {isLoading ? (
            <span className="flex items-center justify-center gap-2">
              ...
              <span className="text-xs xs:text-sm">Updating...</span>
            </span>
          ) : (
            "Update Password"
          )}
