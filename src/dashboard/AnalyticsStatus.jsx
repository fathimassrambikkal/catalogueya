...
function AnalyticsStatus({ range, data }) {
  const cards = [
    { id: 'low-stock', title: 'Low in Stock', value: data?.low_in_stock || 0, color: '#FF9500' },
    { id: 'out-stock', title: 'Out of Stock', value: data?.out_of_stock || 0, color: '#FF3B30' },
    { id: 'sales', title: 'Sales', value: data?.sales || 0, color: '#34C759' },
    { id: 'new-arrivals', title: 'New Arrivals', value: data?.new_arrivals || 0, color: '#007AFF' },
    { id: 'limited-edition', title: 'Limited Edition', value: data?.limited_edition || 0, color: '#AF52DE' },
  ];
