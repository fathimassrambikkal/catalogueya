...
const AddCustomerModal = ({ showAddCustomerModal, setShowAddCustomerModal }) => {
  ...
  const renderCustomerItem = (customer) => (
    <div
      key={customer.id}
      className="flex items-center justify-between p-2 sm:p-3 rounded-xl group gap-1 sm:gap-2 bg-white/80 backdrop-blur-lg border border-gray-200/60 shadow-sm hover:shadow-md hover:border-blue-200/60 transition-all duration-300 min-w-0 w-full max-w-[calc(100vw-32px)]"
      role="listitem"
