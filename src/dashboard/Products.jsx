// Products.jsx (Optimized + iPhone SE scroll fix)
...
export default function Products({
  ...
  const handleSave = () => {
    ...
    if (cleaned.id) {
      ...
      const newProd = { ...cleaned, id: Date.now() };
        ...
        {products.map((p) => (
          ...
          >
            ...
            <div className="mt-2 flex gap-2">
              ...
              <button
                className="flex items-center gap-1 text-red-600 text-sm flex-1 justify-center"
                onClick={() =>
              ...
              <div className="flex items-center gap-2">
                {formData.id && (
                  <button
                    ...
                    onClick={() => {
                      setProducts((prev) =>
                        prev.filter((p) => p.id !== formData.id)
                      );
                      setEditingProduct(null);
                    }}
                  >
              ...
              <section className="bg-white/60 rounded-xl p-4 border">
                ...
                <div className="mt-3 space-y-2">
                  {availableTags.map((tag) => (
                    <label
                      key={tag}
                      className="flex items-center gap-2 p-2 rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100"
                    >
                      <input
                        type="checkbox"
