...
export const EmptyProductsIcon = ({ className = "w-16 h-16" }) => (
  <svg
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
export const ServiceIcon = ({ className = "", size = 14 }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
